        ...
        <form className="booking-final" action="reservation.php" method="post">
          ...
          <div class="elem-group">
            ...
            <select id="venue-selection" name="venue_preference" required>
              ...
              <option value="sport">
                Delhi Lawn Tennis Association Complex
              </option>
              <option value="sport">Siri Fort Complex</option>
              <option value="sport">Saket Sports Complex</option>
              <option value="sport">DDA Sports Complex, Rohini</option>
              <option value="sport">BGS International Public School</option>
            </select>
          </div>
